            ...
            schemas: {
                                            ...
                                            items: {
                                                ...
                                                properties: {
                                                    ...
                                                    schemaName: {
                                                        type: "string",
                                                        example: "acme_corp",
                                                        description: "Database schema name for the tenant (without tenant_ prefix)",
                                                    },
                                                    isPrimary: {
                                                        type: "boolean",
                                                        example: true,
                                                        description: "Whether this is the primary tenant for the user",
                                                    },
                                                },
                ...
                RoleStatistics: {
                    ...
                    properties: {
                        ...
                        totalPermissions: {
                            type: "integer",
                            description: "Total number of unique permissions assigned to roles",
                            example: 25,
                        },
                        averagePermissionsPerRole: {
                            type: "number",
                            format: "float",
                            description: "Average number of permissions per role (for roles with permissions)",
                            example: 3.57,
                        },
                        recentRoles: {
                            type: "array",
                ...
                AuditLog: {
                    ...
                    properties: {
                        ...
                        action: {
                            type: "string",
                            description: 'Action type in namespaced format (e.g., "user.logged_in", "tenant.created", "account.updated"). Common patterns: tenant.*, user.*, account.*',
                        },
                        actor: {
                            type: "object",
                            properties: {
