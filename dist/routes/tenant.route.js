 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/all", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN] }), (0, validate_middleware_1.validate)(tenant_schema_1.tenantListSchema, "query"), tenant_controller_1.getAllTenants);
/**
 * @swagger
 * /tenants:
 *   get:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/", auth_middleware_1.authenticate, (0, validate_middleware_1.validate)(tenant_schema_1.tenantListSchema, "query"), tenant_controller_1.getUserTenants);
/**
 * @swagger
 * /tenants:
 *   post:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post("/", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN] }), (0, validate_middleware_1.validate)(tenant_schema_1.createTenantSchema), tenant_controller_1.createTenantController);
/**
 * @swagger
 * /tenants/{id}:
 *   get:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/:id", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN] }), (0, validate_middleware_1.validate)(tenant_schema_1.tenantIdSchema, "params"), tenant_controller_1.getTenantById);
/**
 * @swagger
 * /tenants/{id}:
 *   patch:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.patch("/:id", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN] }), (0, validate_middleware_1.validate)(tenant_schema_1.tenantIdSchema, "params"), (0, validate_middleware_1.validate)(tenant_schema_1.updateTenantSchema), tenant_controller_1.updateTenantController);
/**
 * @swagger
 * /tenants/{id}:
 *   delete:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.delete("/:id", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN] }), (0, validate_middleware_1.validate)(tenant_schema_1.tenantIdSchema, "params"), tenant_controller_1.deleteTenantById);
/**
 * @swagger
 * /tenants/{id}/restore:
 *   patch:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.patch("/:id/restore", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN] }), (0, validate_middleware_1.validate)(tenant_schema_1.tenantIdSchema, "params"), tenant_controller_1.restoreTenantById);
/**
 * @swagger
 * /tenants/{id}/switch:
 *   post:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post("/:id/switch", auth_middleware_1.authenticate, (0, validate_middleware_1.validate)(tenant_schema_1.tenantIdSchema, "params"), tenant_controller_1.switchTenant);
