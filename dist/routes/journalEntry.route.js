...
const journalEntry_controller_1 = require("../controllers/journalEntry.controller");
const auth_middleware_1 = require("../middlewares/auth.middleware");
const tenantContext_middleware_1 = require("../middlewares/tenantContext.middleware");
const validate_middleware_1 = require("../middlewares/validate.middleware");
const journalEntry_schema_1 = require("../schema/journalEntry.schema");
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(journalEntry_schema_1.journalEntryListSchema, "query"), journalEntry_controller_1.getAllJournalEntries);
/**
 * @swagger
 * /journal-entries/{id}:
 *   get:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/:id", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(journalEntry_schema_1.journalEntryIdSchema, "params"), journalEntry_controller_1.getJournalEntryById);
/**
 * @swagger
 * /journal-entries:
 *   post:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post("/", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(journalEntry_schema_1.createJournalEntrySchema), journalEntry_controller_1.createJournalEntryController);
/**
 * @swagger
 * /journal-entries/{id}:
 *   put:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.put("/:id", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(journalEntry_schema_1.journalEntryIdSchema, "params"), (0, validate_middleware_1.validate)(journalEntry_schema_1.updateJournalEntrySchema), journalEntry_controller_1.updateJournalEntryController);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post("/:id/post", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(journalEntry_schema_1.journalEntryIdSchema, "params"), (0, validate_middleware_1.validate)(journalEntry_schema_1.postJournalEntrySchema, "body"), journalEntry_controller_1.postJournalEntryController);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post("/:id/void", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(journalEntry_schema_1.journalEntryIdSchema, "params"), (0, validate_middleware_1.validate)(journalEntry_schema_1.voidJournalEntrySchema, "body"), journalEntry_controller_1.voidJournalEntryController);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post("/:id/reverse", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(journalEntry_schema_1.journalEntryIdSchema, "params"), (0, validate_middleware_1.validate)(journalEntry_schema_1.reverseJournalEntrySchema, "body"), journalEntry_controller_1.reverseJournalEntryController);
/**
 * @swagger
 * /journal-entries/{id}:
 *   delete:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.delete("/:id", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(journalEntry_schema_1.journalEntryIdSchema, "params"), journalEntry_controller_1.deleteJournalEntryById);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.patch("/:id/restore", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(journalEntry_schema_1.journalEntryIdSchema, "params"), journalEntry_controller_1.restoreJournalEntryById);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post("/:id/duplicate", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(journalEntry_schema_1.journalEntryIdSchema, "params"), (0, validate_middleware_1.validate)(journalEntry_schema_1.duplicateJournalEntrySchema, "body"), journalEntry_controller_1.duplicateJournalEntryController);
