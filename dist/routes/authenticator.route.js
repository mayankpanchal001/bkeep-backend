 ...
 */
router.post("/setup", auth_middleware_1.authenticate, authenticator_controller_1.setupTotp);
/**
 * @swagger
 ...
 */
router.post("/verify", auth_middleware_1.authenticate, (0, validate_middleware_1.validate)(auth_schema_1.totpVerifySchema), authenticator_controller_1.verifyAndEnableTotp);
/**
 * @swagger
 ...
 *               message: 'User not authenticated'
 */
router.post("/deactivate", auth_middleware_1.authenticate, authenticator_controller_1.disableTotp);
/**
 * @swagger
 ...
 *               message: 'User not authenticated'
 */
router.get("/status", auth_middleware_1.authenticate, authenticator_controller_1.getTotpStatus);
/**
 * @swagger
 ...
 *               message: 'User not authenticated'
 */
router.post("/backup-codes", auth_middleware_1.authenticate, authenticator_controller_1.regenerateBackupCodes);
/**
 * @swagger
 ...
 *               message: 'User not authenticated'
 */
router.get("/backup-codes/download", auth_middleware_1.authenticate, authenticator_controller_1.downloadBackupCodes);
