...
const taxExemption_controller_1 = require("../controllers/taxExemption.controller");
const auth_middleware_1 = require("../middlewares/auth.middleware");
const tenantContext_middleware_1 = require("../middlewares/tenantContext.middleware");
const validate_middleware_1 = require("../middlewares/validate.middleware");
const taxExemption_schema_1 = require("../schema/taxExemption.schema");
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(taxExemption_schema_1.taxExemptionListSchema, "query"), taxExemption_controller_1.getAllTaxExemptions);
/**
 * @swagger
 * /tax-exemptions/{id}:
 *   get:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/:id", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(taxExemption_schema_1.taxExemptionIdSchema, "params"), taxExemption_controller_1.getTaxExemptionById);
/**
 * @swagger
 * /tax-exemptions:
 *   post:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post("/", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(taxExemption_schema_1.createTaxExemptionSchema, "body"), taxExemption_controller_1.createTaxExemptionController);
/**
 * @swagger
 * /tax-exemptions/{id}:
 *   put:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.put("/:id", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(taxExemption_schema_1.taxExemptionIdSchema, "params"), (0, validate_middleware_1.validate)(taxExemption_schema_1.updateTaxExemptionSchema, "body"), taxExemption_controller_1.updateTaxExemptionController);
/**
 * @swagger
 * /tax-exemptions/{id}:
 *   delete:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.delete("/:id", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(taxExemption_schema_1.taxExemptionIdSchema, "params"), taxExemption_controller_1.deleteTaxExemptionById);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.patch("/:id/enable", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(taxExemption_schema_1.taxExemptionIdSchema, "params"), taxExemption_controller_1.enableTaxExemption);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.patch("/:id/disable", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(taxExemption_schema_1.taxExemptionIdSchema, "params"), taxExemption_controller_1.disableTaxExemption);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.patch("/:id/restore", auth_middleware_1.authenticate, tenantContext_middleware_1.setTenantContext, tenantContext_middleware_1.requireTenantContext, (0, validate_middleware_1.validate)(taxExemption_schema_1.taxExemptionIdSchema, "params"), taxExemption_controller_1.restoreTaxExemptionById);
