 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN, roles_1.ROLES.ADMIN] }), (0, validate_middleware_1.validate)(user_schema_1.userListSchema, "query"), user_controller_1.getAllUsers);
/**
 * @swagger
 * /users/statistics:
 *   get:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/statistics", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN] }), user_controller_1.getUserStatistics);
/**
 * @swagger
 * /users/invitations:
 *   get:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/invitations", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN, roles_1.ROLES.ADMIN] }), (0, validate_middleware_1.validate)(user_schema_1.invitationListSchema, "query"), userInvitation_controller_1.getAllInvitations);
/**
 * @swagger
 * /users/{id}:
 *   get:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/:id", auth_middleware_1.authenticate, (0, validate_middleware_1.validate)(user_schema_1.userIdSchema, "params"), user_controller_1.getUserById);
/**
 * @swagger
 * /users/profile:
 *   put:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.put("/profile", auth_middleware_1.authenticate, (0, validate_middleware_1.validate)(auth_schema_1.updateProfileSchema), auth_controller_1.updateProfile);
/**
 * @swagger
 * /users/{id}:
 *   delete:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.delete("/:id", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN] }), (0, validate_middleware_1.validate)(user_schema_1.userIdSchema, "params"), user_controller_1.deleteUserById);
/**
 * @swagger
 * /users/{id}/activation:
 *   patch:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.patch("/:id/activation", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN] }), (0, validate_middleware_1.validate)(user_schema_1.userIdSchema, "params"), (0, validate_middleware_1.validate)(user_schema_1.updateUserActivationSchema), user_controller_1.updateUserActivation);
/**
 * @swagger
 * /users/{id}/restore:
 *   patch:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.patch("/:id/restore", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN] }), (0, validate_middleware_1.validate)(user_schema_1.userIdSchema, "params"), user_controller_1.restoreUserById);
/**
 * @swagger
 * /users/{id}/roles:
 *   put:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.put("/:id/roles", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN, roles_1.ROLES.ADMIN] }), (0, validate_middleware_1.validate)(user_schema_1.userIdSchema, "params"), (0, validate_middleware_1.validate)(user_schema_1.updateUserRolesSchema), user_controller_1.updateUserRolesController);
/**
 * @swagger
 * /users/invitation:
 *   post:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post("/invitation", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN, roles_1.ROLES.ADMIN] }), (0, validate_middleware_1.validate)(user_schema_1.userInvitationSchema), userInvitation_controller_1.inviteUser);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.delete("/invitations/:invitationId", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN, roles_1.ROLES.ADMIN] }), (0, validate_middleware_1.validate)(user_schema_1.invitationIdSchema, "params"), userInvitation_controller_1.revokeInvitation);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post("/invitations/:invitationId/resend", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN, roles_1.ROLES.ADMIN] }), (0, validate_middleware_1.validate)(user_schema_1.invitationIdSchema, "params"), userInvitation_controller_1.resendInvitation);
