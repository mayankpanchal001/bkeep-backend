...
const audit_schema_1 = require("../schema/audit.schema");
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN, roles_1.ROLES.ADMIN] }), (0, validate_middleware_1.validate)(audit_schema_1.auditLogListSchema, "query"), audit_controller_1.getAllAuditLogs);
/**
 * @swagger
 * /audit-logs/{id}:
 *   get:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/:id", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN, roles_1.ROLES.ADMIN] }), (0, validate_middleware_1.validate)(audit_schema_1.auditLogIdSchema, "params"), audit_controller_1.getAuditLogById);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/target/:targetType/:targetId", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN, roles_1.ROLES.ADMIN] }), audit_controller_1.getAuditLogsByTarget);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/actor/:actorType/:actorId", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)({ roles: [roles_1.ROLES.SUPERADMIN, roles_1.ROLES.ADMIN] }), audit_controller_1.getAuditLogsByActor);
