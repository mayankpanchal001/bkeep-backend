...
async function up(knex) {
    await knex.schema.createTable("tax_exemptions", (table) => {
        ...
        table
            .uuid("contact_id")
            .notNullable()
            .comment("Reference to the contact (customer/vendor) this exemption applies to");
        ...
        // Indexes
        table.index(["tenant_id", "deleted_at"], "idx_tax_exemptions_tenant_deleted");
        table.index(["tenant_id", "contact_id"], "idx_tax_exemptions_tenant_contact");
