...
async function up(knex) {
    await knex.schema.createTable("account_balance_history", (table) => {
        ...
        table.index(["tenant_id", "account_id", "change_date"], "idx_balance_history_account_date");
        table.index(["tenant_id", "journal_entry_id"], "idx_balance_history_journal_entry");
        table.index(["tenant_id", "change_date"], "idx_balance_history_date");
        table.index(["account_id", "change_date"], "idx_balance_history_account_date_only");
